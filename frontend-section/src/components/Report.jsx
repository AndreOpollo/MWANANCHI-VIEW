...
function Report() {
  ...
  return (
       ...
       <div className='bg-slate-800 border h-full w-15 flex-1 flex-col items-center border-slate-600 m-32 p-8 shadow-lg backdrop-filter backdrop-blur-lg  relative transition-all duration-200'>
            <h1 className='text-4xl text-white font-bold text-center mb-6' >Report System Problem</h1>
            ...
            <div className='relative my-4'>
               ...
               <label htmlFor='textarea' className='absolute text-sm text-white duration-300  transform -translate-y-6 scale-75 top-0 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6'>Report any system challenges</label>
